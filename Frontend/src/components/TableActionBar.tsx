...
import { Filter, Mic, MicOff, Plus, Search, X } from 'lucide-react';
...
const TableActionBar: React.FC<TableActionBarProps> = ({
  ...
  const searchInputValue = listening ? voicePreview : searchValue;
  const voiceButtonLabel = browserSupportsSpeechRecognition
    ? listening
